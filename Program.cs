...
namespace Blackjack
{
    public static class Program
    {
        public static void Main(string[] args)
        {
            ...
            //Zmienne śledzące blackjack
            bool blackjack_gracz =false, blackjack_dealer = false;
            ...
            while (saldo > 0)
            {
                ...
                for (int i = 0; i < 4; i++)
                {
                    if (i == 0) karty_gracz.Add(talia[i]);
                    if (i == 1) karty_dealer.Add(talia[i]);
                    if (i == 2) karty_gracz.Add(talia[i]);
                    if (i == 3) karty_dealer.Add(talia[i]);
                }
                ...
                while (suma_gracz < 21)
                {
                    ...
                    if (akcja == "hit" || akcja == "h")
                    {
                        ...
                        foreach (string karta in karty_gracz) Console.WriteLine(karta);
                        Console.WriteLine(nastepna_gracza);
                        nastepna_w_talii++;
                ...
                else if (blackjack_dealer && !blackjack_gracz) Console.WriteLine($"Przegrywasz {stawka}.");
